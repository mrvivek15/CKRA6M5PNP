...
static uint8_t HS3001_Thread_stack[3072] BSP_PLACE_IN_SECTION(".stack.HS3001_Thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
...
void HS3001_Thread_create(void)
{
    ...
    err = tx_thread_create (&HS3001_Thread, (CHAR*) "HS3001_Thread", HS3001_Thread_func, (ULONG) NULL,
                            &HS3001_Thread_stack, 3072, 3, 3, 1, TX_DONT_START);
    if (TX_SUCCESS != err)
    {
